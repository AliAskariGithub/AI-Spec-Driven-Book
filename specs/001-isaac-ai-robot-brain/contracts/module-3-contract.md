...
## Overview
This contract defines the interface requirements for Module 3: The AI-Robot Brain (NVIDIA Isaac) educational content within the Docusaurus-based learning platform.
...
FRONTMATTER:
  ...
  - title: string ("Module 3: The AI-Robot Brain")
  - description: string ("NVIDIA Isaac for humanoid robots")
REQUIRED SECTIONS:
  - Learning Objectives (bulleted list)
  - Prerequisites (cross-reference to Module 1, 2)
  - Module Overview (introductory content)
  - Chapter Navigation (links to all 3 chapters)
...
```
COMMON FRONTMATTER:
  - sidebar_position: number (1-3 for chapters)
...
CONTRACT:
  ...
  - Category label: "Module 3: The AI-Robot Brain"
  - Items: [module-3/index, module-3/chapter1, module-3/chapter2, module-3/chapter3]
...
```
REQUIREMENTS:
  - All Isaac Sim information must match official documentation
  - Code examples must be verified as functional
  - System requirements must be accurate and up-to-date
  - Cross-references to Isaac ROS must be valid
```
